...
;--------------------------------
!ifdef NOADMIN
	!define MUI_WELCOMEPAGE_TITLE "Welcome to SQLTools 2.0 32-bit Setup (for user w/o admin rights)"
!else
	!define MUI_WELCOMEPAGE_TITLE "Welcome to SQLTools 2.0 32-bit Setup (for user with admin rights)"
!endif
!define MUI_WELCOMEPAGE_TEXT "PLEASE READ THIS INFORMATION CAREFULLY:$\n$\n\
Oracle Client (11g, 12c, 18c or 19c) 32-bit is REQUIRED!$\n$\n\
$\n$\n\
