...
public:
    ...
    CodeOutlineWnd& GetCodeOutlineWnd ()         { return m_wndCodeOutline; }

// Events
    void EvOnConnect ();
    void EvOnDisconnect ();
    void EvOnSettingsChanged ();
...
protected:  // control bar embedded members
    ...
    DockableContainer m_wndCodeOutlineFrame;
    CodeOutlineWnd    m_wndCodeOutline;
...
protected:
    ...
    afx_msg void OnSqlObjViewerSetFocus();
    ...
    afx_msg void OnViewCodeOutline();
    afx_msg void OnUpdate_ViewCodeOutline(CCmdUI* pCmdUI);
    //}}AFX_MSG
...
private:
    // Proxy (SqlToolsProxy) messaging over WM_COPYDATA
    ...
    BOOL HandleProxyCopyData(const COPYDATASTRUCT* pCDS);
public:
