...
class CSQLToolsApp : public CWinAppEx, SettingsSubscriber
{
    ...
    shared_ptr<RecentFileList> m_pRecentFileList;
    shared_ptr<FavoritesList>  m_pFavoritesList;
    ...
    APP_DECLARE_PROPERTY(std::shared_ptr<OCI8::BreakHandler>, BreakHandler);
...
public:
    ...
    shared_ptr<RecentFileList> GetRecentFileList () { return m_pRecentFileList; }
    shared_ptr<FavoritesList>  GetFavoritesList ()  { return m_pFavoritesList;  }
