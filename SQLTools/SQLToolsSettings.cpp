...
static char THIS_FILE[] = __FILE__;
    ...
    CMN_IMPL_PROPERTY(SQLToolsSettings, ObjectViewerCopyPasteOnDoubleClick, true);
    ...
    CMN_IMPL_PROPERTY(SQLToolsSettings, ObjectsListUseComboSelector, true);
    CMN_IMPL_PROPERTY(SQLToolsSettings, ObjectsListTabIconsOnly, false);
    CMN_IMPL_PROPERTY(SQLToolsSettings, ObjectsListOnlySchemasWithObjects, true);

    CMN_IMPL_PROPERTY(SQLToolsSettings, QueryInLowerCase, false);

    // Autocomplete object type filter — all enabled by default
    CMN_IMPL_PROPERTY(SQLToolsSettings, AutocompleteTable,     true);
    CMN_IMPL_PROPERTY(SQLToolsSettings, AutocompleteView,      true);
    CMN_IMPL_PROPERTY(SQLToolsSettings, AutocompletePackage,   true);
    CMN_IMPL_PROPERTY(SQLToolsSettings, AutocompleteProcedure, true);
    CMN_IMPL_PROPERTY(SQLToolsSettings, AutocompleteFunction,  true);
    CMN_IMPL_PROPERTY(SQLToolsSettings, AutocompleteSequence,  true);
    CMN_IMPL_PROPERTY(SQLToolsSettings, AutocompleteSynonym,   true);
    CMN_IMPL_PROPERTY(SQLToolsSettings, AutocompleteType,      true);
    CMN_IMPL_PROPERTY(SQLToolsSettings, AutocompleteSortSubobjects, true);
    CMN_IMPL_PROPERTY(SQLToolsSettings, AutocompleteEnableMultiColumnSelection, true);
    CMN_IMPL_PROPERTY(SQLToolsSettings, AutocompleteInsertColumnsOnSeparateLines, true);
    CMN_IMPL_PROPERTY(SQLToolsSettings, AutocompleteUseLeadingComma, true);
    CMN_IMPL_PROPERTY(SQLToolsSettings, AutocompleteUseLowercaseForAliases, true);
