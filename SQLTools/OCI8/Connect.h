...
public:
    ...
    std::shared_ptr<BreakHandler> CreateBreakHandler ();
    ...
    void DateTimeToText (const OCIDateTime* date, const wchar_t* fmt, size_t fmt_byte_size, int fsprec,
                         const wchar_t* lang_name, size_t lang_byte_size, wchar_t* buf, ub4* buf_byte_size);
    ...
    virtual string GetConnectIdentifier ();
...
protected:
    ...
    string m_strVersion, m_strGlobalName, m_strConnectIdentifier;
