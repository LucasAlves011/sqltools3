...
namespace ObjectTree
{
    ...
    typedef std::shared_ptr<ObjectTree::ObjectDescriptorArray> ObjectDescriptorArrayPtr;
...
public:
    ...
    void ShowObject (const std::string&, const std::string& alias = std::string(), const std::string& column = std::string());
...
protected:
    ...
    void DoOK (const std::string& alias = std::string(), const std::string& column = std::string());
    void OnOK ();
    void OnCancel ();
