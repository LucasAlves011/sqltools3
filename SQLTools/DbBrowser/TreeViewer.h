...
namespace ObjectTree
{
    ...
    typedef std::shared_ptr<ObjectDescriptorArray> ObjectDescriptorArrayPtr;
...
class CTreeViewer : public CTreeCtrlEx
{
    ...
    friend struct BackgroundTask_SelectColumn;
...
public:
    ...
    void ShowObject (const ObjectTree::ObjectDescriptor& objDesc, const std::vector<std::string>& drilldown = std::vector<std::string>(), const std::string alias = std::string());
    void ScheduleSelectColumn (HTREEITEM hRoot, const std::string& column);
