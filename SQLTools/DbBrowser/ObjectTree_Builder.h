...
namespace ObjectTree {
    ...
    public:
        ...
        OT_ATTRIBUTE(std::string, Alias) // added for "Insert at Cursor"
...
// TODO: remove because coluns have been added as children nodes
    ...
    class IndexPartitions : public Folder
    {
    public:
        IndexPartitions (TreeNodePool& treeNodePool, Object* parent)
            : Folder(treeNodePool, parent) {}
        ...
        OT_CLONEABLE_COPYABLE(IndexPartitions)
    };

    class IndexPartition : public Object
    {
    public:
        IndexPartition (TreeNodePool& treeNodePool, Object* parent)
            : Object(treeNodePool, parent) {}
        ...
        OT_CLONEABLE_COPYABLE(IndexPartition)
    };
