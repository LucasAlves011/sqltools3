...
class CConnectDlg : public CDialog
{
    ...
    static bool m_OnLoginPlSqlBlockInitialized;
    static std::wstring m_OnLoginPlSqlBlock;
    static bool m_OnLoginPlSqlBlockEnabled;
...
public:
    ...
    static bool GetOnLoginPlSqlBlock (string& block);
