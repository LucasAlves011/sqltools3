...
//Format
    ...
    GUICommandDictionary::InsertCommand("Edit.FormatSQL",                  ID_EDIT_FORMAT_SQL);
    GUICommandDictionary::InsertCommand("Edit.FormatSQLwithSettings",      ID_EDIT_FORMAT_SQL_WITH_SETTINGS);
//Text/Format
...
//View
    ...
    GUICommandDictionary::InsertCommand("View.ObjectTreeSetFocus",         ID_SQL_OBJ_VIEWER_SETFOCUS);
    ...
    GUICommandDictionary::InsertCommand("View.CodeOutline",                ID_VIEW_CODE_OUTLINE);
