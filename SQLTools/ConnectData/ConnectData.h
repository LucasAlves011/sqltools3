...
public:
    ...
    CD_STREAMABLE_PROPERTY(std::string,  OnLoginPlSqlBlock);    // should be encrypted
    CD_STREAMABLE_PROPERTY(bool,         OnLoginPlSqlBlockEnabled);
    CD_STREAMABLE_PROPERTY(std::string,  Probe);            // use this value for master password verification
    
    private: std::string m_decOnLoginPlSqlBlock; 
...
public:
    ...
    bool DecryptOnLoginPlSqlBlock (const std::wstring& password, std::wstring& block);
    void EncryptOnLoginPlSqlBlock (const std::wstring& password, const std::wstring& block);
    void EncryptProbe (const std::wstring& password);
