...
#include "Common/Fastmap.h"
    ...
    typedef std::shared_ptr<TokenMap> TokenMapPtr;
    ...
    enum EToken
    {
        ...
        etWITH,
        etJOIN,
        // added for set operators support in alias resolution
        etUNION,
        etINTERSECT,
        etALL,
        etINTO, // added for MERGE INTO
        etUSING, // added for MERGE USING
