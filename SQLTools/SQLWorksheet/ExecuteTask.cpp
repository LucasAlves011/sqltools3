...
void BackgroundTask_Execute::DoInBackground (OciConnect& connect)
{
    ...
    try
    {
        ...
        commandParser.SetSubstitution("_USER",               connect.IsOpen() ? connect.GetUID() : "");
        commandParser.SetSubstitution("_CONNECT_IDENTIFIER", connect.IsOpen() ? connect.GetConnectIdentifier() : "");
