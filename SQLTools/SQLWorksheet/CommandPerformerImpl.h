...
{
public:
    CommandPerformerImpl (DocumentProxy& proxy, OciConnect& connect, std::shared_ptr<BindVarHolder>& bindVarHolder, const CommandPerformerSettings&);
    ...
    std::unique_ptr<OciAutoCursor> GetCursorOwnership ();
private:
