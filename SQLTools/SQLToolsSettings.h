...
class SQLToolsSettings : public OpenEditor::BaseSettings, public OraMetaDict::WriteSettings
{
    ...
    friend class CPropAutocompletePage;
...
public:
    ...
    OES_DECL_STREAMABLE_PROPERTY(bool,   ObjectsListUseComboSelector);
    OES_DECL_STREAMABLE_PROPERTY(bool,   ObjectsListTabIconsOnly);
    OES_DECL_STREAMABLE_PROPERTY(bool,   ObjectsListOnlySchemasWithObjects);

    OES_DECL_STREAMABLE_PROPERTY(bool,   QueryInLowerCase);

    // Autocomplete object type filter
    OES_DECL_STREAMABLE_PROPERTY(bool,   AutocompleteTable    );
    OES_DECL_STREAMABLE_PROPERTY(bool,   AutocompleteView     );
    OES_DECL_STREAMABLE_PROPERTY(bool,   AutocompletePackage  );
    OES_DECL_STREAMABLE_PROPERTY(bool,   AutocompleteProcedure);
    OES_DECL_STREAMABLE_PROPERTY(bool,   AutocompleteFunction );
    OES_DECL_STREAMABLE_PROPERTY(bool,   AutocompleteSequence );
    OES_DECL_STREAMABLE_PROPERTY(bool,   AutocompleteSynonym  );
    OES_DECL_STREAMABLE_PROPERTY(bool,   AutocompleteType     );
    OES_DECL_STREAMABLE_PROPERTY(bool,   AutocompleteSortSubobjects);
    OES_DECL_STREAMABLE_PROPERTY(bool,   AutocompleteEnableMultiColumnSelection);
    OES_DECL_STREAMABLE_PROPERTY(bool,   AutocompleteInsertColumnsOnSeparateLines);
    OES_DECL_STREAMABLE_PROPERTY(bool,   AutocompleteUseLeadingComma);
    OES_DECL_STREAMABLE_PROPERTY(bool,   AutocompleteUseLowercaseForAliases);
