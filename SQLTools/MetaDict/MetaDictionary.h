...
namespace OraMetaDict 
{
    ...
    typedef shared_ptr<Tablespace>        TablespacePtr;
    ...
    typedef shared_ptr<PackageBody>       PackageBodyPtr;
    ...
    typedef shared_ptr<TypeBody>          TypeBodyPtr;
    ...
    typedef shared_ptr<JavaSource>        JavaSourcePtr;
    ...
    typedef shared_ptr<Synonym>           SynonymPtr;
    ...
    typedef shared_ptr<Grantor> GrantorPtr;
    ...
    typedef shared_ptr<Grantee> GranteePtr;
    ...
    typedef shared_ptr<DBLink>            DBLinkPtr;
    ...
    typedef shared_ptr<SnapshotLog>       SnapshotLogPtr;
    ...
    typedef shared_ptr<Snapshot>          SnapshotPtr;
