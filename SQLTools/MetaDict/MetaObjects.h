...
namespace OraMetaDict 
{
    ...
    {
    public:
        typedef shared_ptr<IndexPartition> PartitionPtr;
        typedef vector<PartitionPtr> PartitionContainer;
    ...
    public:
        ...
        typedef shared_ptr<IndexPartition> PartitionPtr;
        typedef vector<PartitionPtr> PartitionContainer;
        typedef shared_ptr<TableStorage> IOTOverflowStoragePtr;
    ...
    public:
        typedef shared_ptr<TabColumn> ColumnPtr;
    ...
    //  it is "schema_name"
    //
    typedef shared_ptr<Grant>       GrantPtr;
