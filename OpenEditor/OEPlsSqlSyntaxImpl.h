...
{ 
    ...
    public:
        ...
        const TokenArray& GetTokens () const { return m_tokens; }
    ...
    public:
        ...
        virtual void PutToken (const Token&, std::unique_ptr<SyntaxNode>&);
    ...
    class PackageNode : public SyntaxNodeImpl<FixedArray<Token, 14> >
    {
