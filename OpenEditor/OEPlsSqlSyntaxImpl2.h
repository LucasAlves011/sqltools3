...
{ 
    ...
    struct ScriptFactory
    {
        ...
        static void RecognizeAndCreate (const RecognitionPattern&, std::unique_ptr<SyntaxNode>&);
        static void Create (const RecognitionPattern&, std::unique_ptr<SyntaxNode>&);
        static void feed (const RecognitionPattern&, SyntaxNode&);
    };
    
    struct DmlSqlFactory
    {
        static void RecognizeAndCreate (const Token&, std::unique_ptr<SyntaxNode>&);
    };
