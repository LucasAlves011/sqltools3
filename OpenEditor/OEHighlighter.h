...
namespace OpenEditor
{
    ...
    typedef shared_ptr<HighlighterBase> HighlighterBasePtr;
    ...
    PlSqlHighlighter::PlSqlHighlighter () 
        : CommonHighlighter("PL/SQL"), m_userObjectsGroup(-1) {} 
    ...
    PerlHighlighter::PerlHighlighter ()
        : CommonHighlighter("PERL"), m_variable(false) {} 
};
