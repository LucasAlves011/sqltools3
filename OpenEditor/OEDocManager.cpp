...
COEMultiDocTemplate::COEMultiDocTemplate (UINT nIDResource, CRuntimeClass* pDocClass, CRuntimeClass* pFrameClass, CRuntimeClass* pViewClass, std::shared_ptr<RecentFileList>& recentFileList)
