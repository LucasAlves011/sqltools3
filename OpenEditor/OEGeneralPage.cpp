    ...
    , m_locale(_T(""))*/
{
    ...
    m_UnsupportedAsianChars = settings->GetUnsupportedAsianChars() ? TRUE : FALSE;
}
...
void COEGeneralPage::DoDataExchange(CDataExchange* pDX)
{
    ...
    DDX_Check(pDX, IDC_OE_GEN_UNSUPPORTED_ASIAN_CHARS, m_UnsupportedAsianChars);
}
...
BOOL COEGeneralPage::OnApply()
{
    try { EXCEPTION_FRAME;
        ...
        settings->SetUnsupportedAsianChars(m_UnsupportedAsianChars ? true : false, false /*notify*/);
    }
