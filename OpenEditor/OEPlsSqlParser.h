...
namespace OpenEditor
{
    ...
    // Standalone extended parser for the formatter.
    // Uses the same token map and reserved word table as PlSqlParser
    // but handles signed numbers, q-literals, '' escapes, and
    // multi-line string/comment literals correctly.
    class PlSqlParserEx : public Common::PlsSql::PlSqlParserEx
    {
    public:
        PlSqlParserEx (Common::PlsSql::SyntaxAnalyser&);
    };
