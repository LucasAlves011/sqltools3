...
m_manager(manager)
{
    ...
    m_ColBlockEditMode                = settings->GetColBlockEditMode();  
}
...
void COEBlockPage::DoDataExchange(CDataExchange* pDX)
{
    ...
    DDX_Check(pDX, IDC_OEB_COL_EDIT_MODE,            m_ColBlockEditMode               );
	//}}AFX_DATA_MAP
...
BOOL COEBlockPage::OnApply() 
{
    try { EXCEPTION_FRAME;
        ...
        settings->SetColBlockEditMode                    (m_ColBlockEditMode ? true : false, false /*notify*/);
    }
