...
namespace OpenEditor
{
    ...
    typedef shared_ptr<GlobalSettings> GlobalSettingsPtr;
    typedef shared_ptr<ClassSettings> ClassSettingsPtr;
    ...
    public:
        ...
        OES_DECL_STREAMABLE_PROPERTY(bool,   UnsupportedAsianChars);

        // SQL formatter settings
        OES_DECL_STREAMABLE_PROPERTY(bool,   FmtSimpleStmtEnabled);
        OES_DECL_STREAMABLE_PROPERTY(int,    FmtSimpleStmtMaxLen);
        OES_DECL_STREAMABLE_PROPERTY(bool,   FmtSelectShortListEnabled);
        OES_DECL_STREAMABLE_PROPERTY(int,    FmtSelectShortListMaxLen);
        OES_DECL_STREAMABLE_PROPERTY(bool,   FmtFromShortListEnabled);
        OES_DECL_STREAMABLE_PROPERTY(int,    FmtFromShortListMaxLen);
        OES_DECL_STREAMABLE_PROPERTY(bool,   FmtAlignColumnAliases);
        OES_DECL_STREAMABLE_PROPERTY(int,    FmtBlockShortMaxLen);
        OES_DECL_STREAMABLE_PROPERTY(bool,   FmtSelectStmtEnabled);
        OES_DECL_STREAMABLE_PROPERTY(int,    FmtSelectStmtMaxLen);
        OES_DECL_STREAMABLE_PROPERTY(bool,   FmtGroupByShortListEnabled);
        OES_DECL_STREAMABLE_PROPERTY(int,    FmtGroupByShortListMaxLen);
        OES_DECL_STREAMABLE_PROPERTY(bool,   FmtOrderByShortListEnabled);
        OES_DECL_STREAMABLE_PROPERTY(int,    FmtOrderByShortListMaxLen);
        OES_DECL_STREAMABLE_PROPERTY(bool,   FmtSetOpBlankLine);
        OES_DECL_STREAMABLE_PROPERTY(int,    FmtCaseWhenShortMaxLen);
        OES_DECL_STREAMABLE_PROPERTY(int,    FmtReturningMaxLen);
        OES_DECL_STREAMABLE_PROPERTY(int,    FmtReturningMaxItems);
        OES_DECL_STREAMABLE_PROPERTY(int,    FmtLogErrorsMaxLen);
        OES_DECL_STREAMABLE_PROPERTY(bool,   FmtAlignSetAssignments);
        OES_DECL_STREAMABLE_PROPERTY(bool,   FmtAlignCaseInSet);
        OES_DECL_STREAMABLE_PROPERTY(bool,   FmtBrickListEnabled);
        OES_DECL_STREAMABLE_PROPERTY(int,    FmtBrickListMaxLineLen);
        OES_DECL_STREAMABLE_PROPERTY(int,    FmtBrickListMaxLineItems);
        OES_DECL_STREAMABLE_PROPERTY(int,    FmtBrickListMinItems);
        OES_DECL_STREAMABLE_PROPERTY(bool,   FmtBrickListLinkedInsert);
        OES_DECL_STREAMABLE_PROPERTY(bool,   FmtBrickListLinkedSetOp);

        // PlSql outline settings
        OES_DECL_STREAMABLE_PROPERTY(bool,   PlSqlKeywordNavigation   );
        OES_DECL_STREAMABLE_PROPERTY(int,    PlSqlFileMaxTokens       );
        OES_DECL_STREAMABLE_PROPERTY(int,    PlSqlFileMaxLines        );
        OES_DECL_STREAMABLE_PROPERTY(bool,   PlSqlOutlineEnabled      );
        OES_DECL_STREAMABLE_PROPERTY(bool,   PlSqlOutlineSelectEnabled);
        OES_DECL_STREAMABLE_PROPERTY(bool,   PlSqlOutlineSelectOnly   );     // enabled only select w/o from and where
        OES_DECL_STREAMABLE_PROPERTY(int,    PlSqlOutlineMaxTopItems  );
    };
    ...
    public:
        ...
        OES_AGGREGATE_GLOBAL_PROPERTY(bool,   UnsupportedAsianChars);

        // SQL formatter settings
        OES_AGGREGATE_GLOBAL_PROPERTY(bool,   FmtSimpleStmtEnabled);
        OES_AGGREGATE_GLOBAL_PROPERTY(int,    FmtSimpleStmtMaxLen);
        OES_AGGREGATE_GLOBAL_PROPERTY(bool,   FmtSelectShortListEnabled);
        OES_AGGREGATE_GLOBAL_PROPERTY(int,    FmtSelectShortListMaxLen);
        OES_AGGREGATE_GLOBAL_PROPERTY(bool,   FmtFromShortListEnabled);
        OES_AGGREGATE_GLOBAL_PROPERTY(int,    FmtFromShortListMaxLen);
        OES_AGGREGATE_GLOBAL_PROPERTY(bool,   FmtAlignColumnAliases);
        OES_AGGREGATE_GLOBAL_PROPERTY(int,    FmtBlockShortMaxLen);
        OES_AGGREGATE_GLOBAL_PROPERTY(bool,   FmtSelectStmtEnabled);
        OES_AGGREGATE_GLOBAL_PROPERTY(int,    FmtSelectStmtMaxLen);
        OES_AGGREGATE_GLOBAL_PROPERTY(bool,   FmtGroupByShortListEnabled);
        OES_AGGREGATE_GLOBAL_PROPERTY(int,    FmtGroupByShortListMaxLen);
        OES_AGGREGATE_GLOBAL_PROPERTY(bool,   FmtOrderByShortListEnabled);
        OES_AGGREGATE_GLOBAL_PROPERTY(int,    FmtOrderByShortListMaxLen);
        OES_AGGREGATE_GLOBAL_PROPERTY(bool,   FmtSetOpBlankLine);
        OES_AGGREGATE_GLOBAL_PROPERTY(int,    FmtCaseWhenShortMaxLen);
        OES_AGGREGATE_GLOBAL_PROPERTY(int,    FmtReturningMaxLen);
        OES_AGGREGATE_GLOBAL_PROPERTY(int,    FmtReturningMaxItems);
        OES_AGGREGATE_GLOBAL_PROPERTY(int,    FmtLogErrorsMaxLen);
        OES_AGGREGATE_GLOBAL_PROPERTY(bool,   FmtAlignSetAssignments);
        OES_AGGREGATE_GLOBAL_PROPERTY(bool,   FmtAlignCaseInSet);
        OES_AGGREGATE_GLOBAL_PROPERTY(bool,   FmtBrickListEnabled);
        OES_AGGREGATE_GLOBAL_PROPERTY(int,    FmtBrickListMaxLineLen);
        OES_AGGREGATE_GLOBAL_PROPERTY(int,    FmtBrickListMaxLineItems);
        OES_AGGREGATE_GLOBAL_PROPERTY(int,    FmtBrickListMinItems);
        OES_AGGREGATE_GLOBAL_PROPERTY(bool,   FmtBrickListLinkedInsert);
        OES_AGGREGATE_GLOBAL_PROPERTY(bool,   FmtBrickListLinkedSetOp);

        // PlSql navigation and outline settings
        OES_AGGREGATE_GLOBAL_PROPERTY(bool,   PlSqlKeywordNavigation   ); // navigation between SELECT/FROM/WHERE and IF/ESLSE/END IF, also required for PlSql Outline
        OES_AGGREGATE_GLOBAL_PROPERTY(int,    PlSqlFileMaxTokens       );
        OES_AGGREGATE_GLOBAL_PROPERTY(int,    PlSqlFileMaxLines        );
        OES_AGGREGATE_GLOBAL_PROPERTY(bool,   PlSqlOutlineEnabled      );
        OES_AGGREGATE_GLOBAL_PROPERTY(bool,   PlSqlOutlineSelectEnabled);
        OES_AGGREGATE_GLOBAL_PROPERTY(bool,   PlSqlOutlineSelectOnly   );
        OES_AGGREGATE_GLOBAL_PROPERTY(int,    PlSqlOutlineMaxTopItems  );
