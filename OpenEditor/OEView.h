...
protected:
    ...
    afx_msg void OnUpdate_StreamSelectionOperation(CCmdUI* pCmdUI);
...
public:
    ...
    afx_msg void OnEditFormatSql ();
    afx_msg void OnEditFormatSqlWithSettings ();
