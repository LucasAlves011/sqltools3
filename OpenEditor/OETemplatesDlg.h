...
public:
    COETemplatesDlg (CWnd* pParent, Mode mode, const OpenEditor::Template&, OpenEditor::Template::Entry&, const Common::VisualAttribute& textAttr);
...
protected:
    Mode m_mode;
    const OpenEditor::Template& m_template;
    ...
    CSize m_minSize;
    CPoint m_textTopLeft, m_hintTopLeft;
    CSize m_okOffset, m_cancelOffset, m_textOffset, m_hintOffset;
