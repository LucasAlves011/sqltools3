...
//
//    std::unique_ptr<TiXmlElement> rootElem(new TiXmlElement(ROOT_ELEM));
//
//    std::unique_ptr<TiXmlElement> settingsElem(new TiXmlElement(SETTINGS));
...
//    
//    std::unique_ptr<TiXmlElement> classesElem(new TiXmlElement(CLASSES));
//
...
//        
//        std::unique_ptr<TiXmlElement> classElem(new TiXmlElement(CLASS));
//        writeAwareness(*classPtr, classElem.get());
//
//        std::unique_ptr<TiXmlElement> vasetElem(new TiXmlElement(VISUAL_ATTRIBUTES));
//        write(classPtr->GetVisualAttributesSet(), vasetElem.get());
//        classElem->LinkEndChild(vasetElem.release());
//        
//        std::unique_ptr<TiXmlElement> markersElem(new TiXmlElement(COLUMN_MARKERS));
...
//    {
//        std::unique_ptr<TiXmlElement> vaElem(new TiXmlElement(VISUAL_ATTRIBUTE));
