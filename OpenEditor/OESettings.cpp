...
// 	GloalSettings
    ...
    CMN_IMPL_PROPERTY(GlobalSettings, UnsupportedAsianChars,            false);

    // SQL formatter settings
    CMN_IMPL_PROPERTY(GlobalSettings, FmtSimpleStmtEnabled,            true);
    CMN_IMPL_PROPERTY(GlobalSettings, FmtSimpleStmtMaxLen,             60);
    CMN_IMPL_PROPERTY(GlobalSettings, FmtSelectShortListEnabled,       true);
    CMN_IMPL_PROPERTY(GlobalSettings, FmtSelectShortListMaxLen,        40);
    CMN_IMPL_PROPERTY(GlobalSettings, FmtFromShortListEnabled,         true);
    CMN_IMPL_PROPERTY(GlobalSettings, FmtFromShortListMaxLen,          40);
    CMN_IMPL_PROPERTY(GlobalSettings, FmtAlignColumnAliases,           true);
    CMN_IMPL_PROPERTY(GlobalSettings, FmtBlockShortMaxLen,             60);
    CMN_IMPL_PROPERTY(GlobalSettings, FmtSelectStmtEnabled,            true);
    CMN_IMPL_PROPERTY(GlobalSettings, FmtSelectStmtMaxLen,             60);
    CMN_IMPL_PROPERTY(GlobalSettings, FmtGroupByShortListEnabled,      true);
    CMN_IMPL_PROPERTY(GlobalSettings, FmtGroupByShortListMaxLen,       60);
    CMN_IMPL_PROPERTY(GlobalSettings, FmtOrderByShortListEnabled,      true);
    CMN_IMPL_PROPERTY(GlobalSettings, FmtOrderByShortListMaxLen,       60);
    CMN_IMPL_PROPERTY(GlobalSettings, FmtSetOpBlankLine,               false);
    CMN_IMPL_PROPERTY(GlobalSettings, FmtCaseWhenShortMaxLen,          40);
    CMN_IMPL_PROPERTY(GlobalSettings, FmtReturningMaxLen,              60);
    CMN_IMPL_PROPERTY(GlobalSettings, FmtReturningMaxItems,            5);
    CMN_IMPL_PROPERTY(GlobalSettings, FmtLogErrorsMaxLen,              40);
    CMN_IMPL_PROPERTY(GlobalSettings, FmtAlignSetAssignments,          true);
    CMN_IMPL_PROPERTY(GlobalSettings, FmtAlignCaseInSet,               true);
    CMN_IMPL_PROPERTY(GlobalSettings, FmtBrickListEnabled,             true);
    CMN_IMPL_PROPERTY(GlobalSettings, FmtBrickListMaxLineLen,          80);
    CMN_IMPL_PROPERTY(GlobalSettings, FmtBrickListMaxLineItems,        10);
    CMN_IMPL_PROPERTY(GlobalSettings, FmtBrickListMinItems,            5);
    CMN_IMPL_PROPERTY(GlobalSettings, FmtBrickListLinkedInsert,        true);
    CMN_IMPL_PROPERTY(GlobalSettings, FmtBrickListLinkedSetOp,         true);

    // PlSql navigation and outline settings
    CMN_IMPL_PROPERTY(GlobalSettings, PlSqlKeywordNavigation   , true);
    CMN_IMPL_PROPERTY(GlobalSettings, PlSqlFileMaxTokens       , 15000);
    CMN_IMPL_PROPERTY(GlobalSettings, PlSqlFileMaxLines        , 3000);
    CMN_IMPL_PROPERTY(GlobalSettings, PlSqlOutlineEnabled      , true);
    CMN_IMPL_PROPERTY(GlobalSettings, PlSqlOutlineSelectEnabled, true);
    CMN_IMPL_PROPERTY(GlobalSettings, PlSqlOutlineSelectOnly   , false);
    CMN_IMPL_PROPERTY(GlobalSettings, PlSqlOutlineMaxTopItems  , 500);
