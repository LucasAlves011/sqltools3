...
namespace OpenEditor
{
    ...
    public:
        ...
        // it is not used in OE but required for SQLTools
        OET_ATTRIBUTE(bool, MultiSelectionSupported);
        virtual void SetMultiSelection (const vector<int>&) {};
        ...
        bool WantsSortedList () const                     { return m_sortedList; }
        void SetSortedList (bool val)                     { m_sortedList = val; }
    ...
    Template::Template () : m_KeyColumnHeader("Key"), m_NameColumnHeader("Name"), m_ImageListRes((UINT)-1)
        {
            ...
            m_modified = false; 
            m_MultiSelectionSupported = false;
        }
