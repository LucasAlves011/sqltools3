...
void COEPrintPageSetup::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Check(pDX, IDC_PPS_LINE_NUMBERS, m_LineNumbers);
...
LRESULT COEPrintPageSetup::WindowProc(UINT message, WPARAM wParam, LPARAM lParam)
{
    try { EXCEPTION_FRAME;
