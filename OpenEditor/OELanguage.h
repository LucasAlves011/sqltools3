...
namespace OpenEditor
{
    ...
    typedef std::shared_ptr<LanguageKeywordMap> LanguageKeywordMapPtr;

    class Language
    {
    public:
        Language () 
            : m_LanguageKeywordMap(new LanguageKeywordMap), 
             m_caseSensiteve(false),
             m_endLineCommentCol(-1)
            {}
        ...
        const int GetEndLineCommentCol () const;
        ...
        void SetLanguageKeywordMap (LanguageKeywordMapPtr languageKeywordMap);
    ...
    private:
        ...
        */
        ...
        friend class LanguageXmlStreamer;
    };
    ...
    public:
        ...
        static void Update (LanguagePtr);
   ...
   private:
    ...
    inline
    const int Language::GetEndLineCommentCol () const
        { return m_endLineCommentCol; }
    inline
