...
// CErrorDlg dialog
CErrorDlg::CErrorDlg (LPCSTR text, LPCSTR reportPrefix, BOOL compact /*= FALSE*/)
: CDialog(!compact ? IDD_ERROR : IDD_ERROR_SMALL),
...
void CErrorDlg::OnGetMinMaxInfo(MINMAXINFO* lpMMI)
{
