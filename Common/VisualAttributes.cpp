...
namespace Common
{
    CMN_IMPL_PROPERTY_BINDER(VisualAttribute);
    CMN_IMPL_PROPERTY(VisualAttribute, Name,         ""   );
    CMN_IMPL_PROPERTY(VisualAttribute, FontName,     ""   );
    CMN_IMPL_PROPERTY(VisualAttribute, FontSize,     0    );
    CMN_IMPL_PROPERTY(VisualAttribute, FontBold,     false);
    CMN_IMPL_PROPERTY(VisualAttribute, FontItalic,   false);
    CMN_IMPL_PROPERTY(VisualAttribute, FontUnderline,false);
    CMN_IMPL_PROPERTY(VisualAttribute, Foreground,   0    );
    CMN_IMPL_PROPERTY(VisualAttribute, Background,   0    );
    CMN_IMPL_PROPERTY(VisualAttribute, Mask,         0    );
...
const VisualAttribute& VisualAttributesSet::FindByName (const char* name) const
{
    ...
    // unknown problem on win98 - i cannot use _RAISE here!!!
    //_RAISE(std::out_of_range(std::string("Visual attribute \"") + name + "\" not found in set \"" + m_name + "\"."));
