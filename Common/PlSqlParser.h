...
namespace PlsSql
{
    ...
    typedef std::shared_ptr<Reserved> ReservedPtr;
    ...
    enum EToken
    {
        ...
        // added for formatter (DML)
        etRETURNING,
        etINTO,
        etLOG,
        etVALUES,    // added for INSERT formatter
