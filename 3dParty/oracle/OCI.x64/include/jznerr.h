...
/* 
   ...
   apfwkr      11/18/25 - CI #38667739 of dmcmahon_bug-38221048 from main
   ...
   dmcmahon    05/14/26 - JZNERR_MEM_TOO_LARGE
   zliu        04/04/26 - Bug 39168071: add JCT ETAG related JZNERR errors
   zliu        03/08/26 - Bug 39059953: JZNERR_JCT_ID_MISSING
   dmcmahon    02/11/26 - Bug 38956148: annotation errors
   zliu        12/15/25 - Bug 38802310: JZNERR_KEYVAL_NOOBJ
   dmcmahon    10/21/25 - Bug 38421410: More BOV errors
...
#define JZNERR_MEM_TOO_LARGE          99 /* Memory request too large         */
...
#define JZNERR_JCT_ID_MISSING         487          /* _id missing for JCT */
#define JZNERR_JCT_ID_ALTERED         488          /* _id mutated for JCT */
#define JZNERR_JCT_ETAG_MISMATCH      489          /* stale ETAG detected */
#define JZNERR_JCT_INVALID_ETAG       490          /* invalid _metadata.etag */
/*JCT:JSON Collection Table feature where each JSON doc must have _id field and valid etag*/

/*
** Through 490 reserved for JSON Collection Table errors
*/

/*
** 491 - 499 reserved for execution-time errors in path/calc/gather engines
*/
...
#define JZNERR_BOV_MIXED_BUILD_MODES  619      /* invalid mix of build modes */
...
#define JZNERR_BOV_BAD_CARDINALITY    667        /* field ~s wrong container */
#define JZNERR_BOV_NO_SUCH_FIELD      668              /* Field ~d not found */
#define JZNERR_BOV_INVALID_ANNOTATION 669
#define JZNERR_BOV_INVALID_LOV        670
...
#define JZNERR_BOV_INVALID_ASSOC      696   /* Invalid associative target ~s */
#define JZNERR_BOV_UNKNOWN_CONTAINER  697            /* unknown container ~d */
#define JZNERR_BOV_NO_CONTAINER_NAME  698
#define JZNERR_BOV_CONTAINER_MAPPED   699
...
/*
** More path errors: 820-830
*/
#define JZNERR_NESTED_ARY  821 /* nested array encountered for path eval */
#define JZNERR_KEYVAL_NOOBJ 822 /* keyvalue() is not applied to json object*/
/*
